        ...
        <section id="about" className="py-20 bg-black/50">
          <div className="container mx-auto px-4 md:px-6 text-center max-w-4xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <ScrollReveal delay={0.2} className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
                <div className="text-viprobac text-4xl font-bold mb-2">100+</div>
                <div className="text-sm text-gray-400">Sites Treated</div>
              </ScrollReveal>
              {/* <ScrollReveal delay={0.4} className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
                <div className="text-viprogro text-4xl font-bold mb-2">99%</div>
                <div className="text-sm text-gray-400">Pollutant Reduction</div>
              </ScrollReveal> */}
              <ScrollReveal delay={0.6} className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
                <div className="text-blue-400 text-4xl font-bold mb-2">SANS</div>
                <div className="text-sm text-gray-400">Compliant Solutions</div>
              </ScrollReveal>
            </div>
          </div>
        </section>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                <div className="relative h-[400px] lg:h-auto overflow-hidden group">
                  ...
                  <img
                    ...
                    className="object-cover w-full h-full transition-transform duration-1000 group-hover:scale-110 grayscale hover:grayscale-0"
                  />
                </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* ViProGro Card */}
              {/* <ScrollReveal direction="right" delay={0.2} parallax className="group relative overflow-hidden rounded-3xl border border-viprogro/20 bg-viprogro/5 p-8 transition-all hover:border-viprogro/50 hover:shadow-[0_0_30px_rgba(0,255,136,0.2)]">
                ...
                <Link href="/viprogro">
                  <Button variant="viprogro" className="w-full">
                    Learn More <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </Link>
              </ScrollReveal> */}
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4 text-gray-300">
                    ...
                    <div>
                      ...
                      <div className="font-bold">+27 (0) 12 345 6789</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 text-gray-300">
                    <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center border border-white/10">
                    ...
                    <div>
                      ...
                      <div className="font-bold">info@viprogroup.co.za</div>
                    </div>
                  </div>
                </div>
              </ScrollReveal>
